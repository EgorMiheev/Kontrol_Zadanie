package com.example.kontrol_zadanie.adapter;
...
import com.example.kontrol_zadanie.CoursePage;
import com.example.kontrol_zadanie.R;
import com.example.kontrol_zadanie.model.Course;

import java.util.List;

public class CourseAdapter extends RecyclerView.Adapter<CourseAdapter.CourseViewHodler> {
    ...
    @NonNull
    @Override
    public CourseViewHodler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View courseItems = LayoutInflater.from(context).inflate(R.layout.course_item, parent, false);
        return new CourseAdapter.CourseViewHodler(courseItems);
    }

    @Override
    public void onBindViewHolder(@NonNull CourseAdapter.CourseViewHodler holder, int position) {
    ...
    public  static final class CourseViewHodler extends RecyclerView.ViewHolder {

        CardView courseBg;
        ImageView courseImage;
        TextView courseTitle, courseDate, courseLevel;

        public CourseViewHodler(@NonNull View itemView) {
            super(itemView);

            courseBg = (CardView) itemView.findViewById(R.id.courseBg);
            ...
            courseLevel = (TextView) itemView.findViewById(R.id.courseLevel);
